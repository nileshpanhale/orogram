...
app.post('/uploadmultiple', upload.array('myFiles', 12), (req, res, next) => {
  ...
  // getting txhash Details --------------------------------------------------------------------
    ...
    router.route('/getLandContractTrades')
    .get(authorize(), controller.getLandTradesHistory);


    router.route('/confirmLandTransaction/:id')
    .put(authorize(), controller.confirmLandTransaction);
